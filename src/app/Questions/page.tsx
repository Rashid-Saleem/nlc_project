        ...
        <div className="flex flex-col gap-10 lg:flex-row items-center justify-between">
          <div className="lg:w-1/2  text-left">
            <h1 className="text-4xl lg:text-6xl text-black font-bold  mb-6 sm:mb-2" data-aos="fade-right">
              Discover the Latest 
              <span data-aos="flip-left" className="text-red-500"> Course</span> <span className="text-gray-700" data-aos="flip-right">of AI </span>
            </h1>
...
<div className="max-w-screen-xl mx-auto px-5 bg-white min-h-sceen">
	...
	<div className="grid divide-y divide-neutral-200 max-w-xl mx-auto mt-8">
		...
		<div className="py-5">
			<details className="group">
				<summary className="flex justify-between items-center font-medium cursor-pointer list-none">
					<span> Is there any age limit for Admission in AI?</span>
					<span className="transition group-open:rotate-180">
                <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path>
</svg>
              </span>
