  ...
  return (
    ...
    <div className="bg-[#FFFFFF]"  >
          ...
          <div className="mt-6 space-y-3 sm:font-sm md:font-medium lg:font-bold sm:text-sm md:text-lg lg:text-lg  sm:text-center md:text-center lg:text-center">
            <h2 className="font-mono font-bold  text-center text-4xl items-center  text-red-500" data-aos="fade-right">Our Campuses</h2>
            <p className="font-serif font-sm text-center text-gray-700 items-center  text-2xl" data-aos="fade-right">We have four campuses in Pakistan</p>
          </div>
